...
namespace ORS_RCM_BL
{
    public class Item_BL
    {
        ...
        public DataTable SearchItem(string ItemCode, string proname, string procode, string catInfo, string bname, string compname, string year, string season, string jan, int stock_flag, int pindex,int psize,int option,Boolean isSearch)
        {
            return itemDL.SearchItem(ItemCode, proname, procode, catInfo, bname, compname, year, season, jan, stock_flag, pindex, psize,option,isSearch);
        }
