...
namespace Item_ImageAll_Backup_Console
{
    ...
    /// </summary>
    public class BoxFilesManager1 : BoxResourceManager
    {
        public BoxFilesManager1(IBoxConfig config, IBoxService service, IBoxConverter converter, IAuthRepository auth, string asUser = null, bool? suppressNotifications = null)
        ...
        public async Task<IEnumerable<BoxSessionPartInfo>> UploadPartsInSessionAsync(
