<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Item_Master.aspx.cs" Inherits="ORS_RCM.WebForms.Item.Item_Master_Edit1" %>
...
<script type="text/javascript">
    function AddSKU(ctrl) {
        ...
        if (itemcode.indexOf("itemcode") >= 0) {
            var txtitemcode = document.getElementById("<%=txtItem_Code.ClientID %>").innerHTML;
...
<label for="tab1" style="padding: 0px 6px;position:fixed;">RCM_Item</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input id="tab2" type="radio" name="tabs" style="visibility:hidden;border-top: 1px solid #ddd;padding: 0px 16px;position:fixed;">
<label for="tab2" style="padding: 0px 16px;position:fixed;">ものたろう</label>
<section id="content1">
<!-- EditArea -->
<div class="itemCmnSet editPage">
<div id="block1" class="cmnEdit inlineSet" style="overflow-y:scroll;overflow-x:unset;max-height:500px;">
        <dl class="itemNo" id="lblitemcode" runat="server">
			<dt>商品番号</dt>
      ...
      <div class="lblstyle" style="width:307px;height:28px;">
        ...
        <div class="lblstyle" style="width:307px;height:28px;">
            ...
            <script type="text/javascript">
                $("#<%= txtSale_Price.ClientID %>").keyup(function () {
                    var input = $(this);
                    if (input.val() != "") {
                        $("#<%= btnComplete.ClientID %>").attr("disabled", false);
                    } else { $("#<%= btnComplete.ClientID %>").attr("disabled", $(this).val() == ""); }
                });
            </script>
            <dt style="margin-left: 3px;">原価率</dt>
             <dd style="margin-left:6px;"><asp:Label runat="server" ID="lblcostrate"/></dd>
        </div>
        <div class="lblstyle" style="width:350px;height:28px;">
            <dt>利益率</dt>
    ...
    <div class="lblstyle" style="width:350px;height:28px;margin-left:100px;">
        <asp:Button runat="server"  ID="btnCalculate" Text="個別価格" OnClick="btnCalculate_Click" />
    </div>
    <div id="priceDiv" runat="server" style="width:310px;" visible="false">
         <div class="lblstyle" style="width:307px;height:28px;">
             <dt style="width:115px;">楽天価格(税抜)</dt>
             <dd style="margin-left:6px;"><asp:TextBox ID="txtRakutenPrice" runat="server" Width="100px"></asp:TextBox></dd>
         </div>
        <div class="lblstyle" style="width:307px;height:28px;">
            <dt style="width:115px;">Yahoo価格(税抜)</dt>
            <dd style="margin-left:6px;"><asp:TextBox ID="txtYahooPrice" runat="server" Width="100px"></asp:TextBox></dd>
        </div>
        <div class="lblstyle" style="width:307px;height:28px;">
            <dt style="width:115px;">Wowma価格(税抜)</dt>
            <dd style="margin-left:6px;"><asp:TextBox ID="txtWowmaPrice" runat="server" Width="100px"></asp:TextBox></dd>
        </div>
        <div class="lblstyle" style="width:307px;height:28px;">
            <dt style="width:115px;">自社価格(税抜)</dt>
            <dd style="margin-left:6px;"><asp:TextBox ID="txtJishaPrice" runat="server" Width="100px"></asp:TextBox></dd>
        </div>
        <div class="lblstyle" style="width:307px;height:28px;">
            <dt style="width:115px;">ORS価格(税抜)</dt>
            <dd style="margin-left:6px;"><asp:TextBox ID="txtTennisPrice" runat="server" Width="100px"></asp:TextBox></dd>
        </div>
    </div>
     ...
     <div id="imgEntryTechnology">
			<dl>
               ...
               <dd>
                   ...
                   <p><asp:HyperLink rel="lightbox[roadtrip]" runat="server" ID="hlImage6"><asp:Image runat="server" ID="Image6" ImageUrl="~/Item_Image/no_image.jpg"/></asp:HyperLink></p>
                   <p><asp:HyperLink rel="lightbox[roadtrip]" runat="server" ID="hlImage7"><asp:Image runat="server" ID="Image7" ImageUrl="~/Item_Image/no_image.jpg"/></asp:HyperLink></p>
                   <p><asp:HyperLink rel="lightbox[roadtrip]" runat="server" ID="hlImage8"><asp:Image runat="server" ID="Image8" ImageUrl="~/Item_Image/no_image.jpg"/></asp:HyperLink></p>
                   <p><asp:HyperLink rel="lightbox[roadtrip]" runat="server" ID="hlImage9"><asp:Image runat="server" ID="Image9" ImageUrl="~/Item_Image/no_image.jpg"/></asp:HyperLink></p>
                   <p><asp:HyperLink rel="lightbox[roadtrip]" runat="server" ID="hlImage10"><asp:Image runat="server" ID="Image10" ImageUrl="~/Item_Image/no_image.jpg"/></asp:HyperLink></p>

                    <p><asp:HyperLink rel="lightbox[roadtrip]" runat="server" ID="hlImage11"><asp:Image runat="server" ID="Image11" ImageUrl="~/Item_Image/no_image.jpg"/></asp:HyperLink></p>
                   <p><asp:HyperLink rel="lightbox[roadtrip]" runat="server" ID="hlImage12"><asp:Image runat="server" ID="Image12" ImageUrl="~/Item_Image/no_image.jpg"/></asp:HyperLink></p>
                   <p><asp:HyperLink rel="lightbox[roadtrip]" runat="server" ID="hlImage13"><asp:Image runat="server" ID="Image13" ImageUrl="~/Item_Image/no_image.jpg"/></asp:HyperLink></p>
                   <p><asp:HyperLink rel="lightbox[roadtrip]" runat="server" ID="hlImage14"><asp:Image runat="server" ID="Image14" ImageUrl="~/Item_Image/no_image.jpg"/></asp:HyperLink></p>
                   <p><asp:HyperLink rel="lightbox[roadtrip]" runat="server" ID="hlImage15"><asp:Image runat="server" ID="Image15" ImageUrl="~/Item_Image/no_image.jpg"/></asp:HyperLink></p>

                    <p><asp:HyperLink rel="lightbox[roadtrip]" runat="server" ID="hlImage16"><asp:Image runat="server" ID="Image16" ImageUrl="~/Item_Image/no_image.jpg"/></asp:HyperLink></p>
                   <p><asp:HyperLink rel="lightbox[roadtrip]" runat="server" ID="hlImage17"><asp:Image runat="server" ID="Image17" ImageUrl="~/Item_Image/no_image.jpg"/></asp:HyperLink></p>
                   <p><asp:HyperLink rel="lightbox[roadtrip]" runat="server" ID="hlImage18"><asp:Image runat="server" ID="Image18" ImageUrl="~/Item_Image/no_image.jpg"/></asp:HyperLink></p>
                   <p><asp:HyperLink rel="lightbox[roadtrip]" runat="server" ID="hlImage19"><asp:Image runat="server" ID="Image19" ImageUrl="~/Item_Image/no_image.jpg"/></asp:HyperLink></p>
                   <p><asp:HyperLink rel="lightbox[roadtrip]" runat="server" ID="hlImage20"><asp:Image runat="server" ID="Image20" ImageUrl="~/Item_Image/no_image.jpg"/></asp:HyperLink></p>
               </dd>
			</dl>
			<dl>
				<dt>テクノロジー画像</dt>
...
<div id="block2">
	...
	<div class="dBlock box2 inlineSet">
		...
		<dl class="shopCategory">
			<dt>ショップカテゴリ1 <input type="button" id = "btnAddCatagories" onclick ="ShowCatagoryList(this)" value="選 ぶ" runat="server"/></dt>
			<dd>
  ...
  <asp:Label runat="server" ID="lblcat2" Text="ショップカテゴリ 選 ぶ2" Visible="false"/> &nbsp;&nbsp;<asp:Button ID="btnCategoryAdd" runat="server" Text="選 ぶ" OnClick="btnCategoryAdd_OnClick" Width="57px" Visible="false" />
	...
	<div class="dBlock itemCategory inlineSet">
		<dl>
			<dt style="height:130px;">カテゴリID<br/>Yahooスペック</dt>
			<dd>
            ...
            <p>Wowma<asp:TextBox runat="server" ID="txtWowma_CategoryID" ReadOnly="true" onkeypress="return isNumberKeys(event)" Width="100px"/>
            <asp:TextBox runat="server" ID="txtWowma_CategoryPath" ReadOnly="true" onkeypress="return isNumberKeys(event)" Width="350px"/>
            <input type="button" id = "btnWowma_CategoryID" onclick ="ShowMallCategory(4,this)" value="選 ぶ" runat="server"/></p>
            <%--hhw--%>
            <%--<p>ORS自社<asp:TextBox runat="server" ID="txtTennis_CategoryID" ReadOnly="true" onkeypress="return isNumberKeys(event)" Width="100px"/>
            <asp:TextBox runat="server" ID="txtTennis_CategoryPath" ReadOnly="true" onkeypress="return isNumberKeys(event)" Width="350px"/>
            <input type="button" id = "btnTennis_CategoryID" onclick ="ShowMallCategory(7,this)" value="選 ぶ" runat="server"/></p>--%>
	...
	<div class="dBlock Exhibit">
	  <dl>
	    <dt style ="height :112px">出品対象ショップ</dt>
          <asp:UpdatePanel runat="server" id="UpdatePanel" updatemode="Conditional" >
              <ContentTemplate>
		        <dd runat="server" id="dd1">
                    ...
                    <asp:DataList ID="dlShop1" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        <ItemTemplate>
                            <p><asp:CheckBox runat="server" ID="ckbMall1Shop" EnableViewState="true" Text='<%# Bind("Mall_Name")%>' /><asp:Label runat="server" ID="lblMall1ShopID" Text='<%# Bind("ID")%>' Visible="false" /></p>
                        </ItemTemplate>
                    </asp:DataList>
			    </dd>
              </ContentTemplate>
           ...
           <asp:UpdatePanel runat="server" id="UpdatePanel6" updatemode="Conditional">
               <ContentTemplate>
			    <dd runat="server" id="dd6">
				    <b><asp:Label runat="server" ID="lblShopName6" Text=""></asp:Label></b>
                      <!-------------------We used  出品対象ショップ  binding method  for    DataList of Asp.net--------------------------------->
                    <asp:DataList ID="dlShop6" runat="server"  RepeatDirection="Horizontal" RepeatColumns="5" RepeatLayout="Flow">
                        <ItemTemplate >
                            <p><asp:CheckBox runat="server" ID="ckbMall6Shop" EnableViewState="true" Text='<%# Bind("Mall_Name")%>'/> <asp:Label runat="server" ID="lblMall6ShopID" Text='<%# Bind("ID")%>' Visible="false" /> </p>
                        </ItemTemplate>
                    </asp:DataList>
			    </dd>
               </ContentTemplate> 
               <Triggers>
                <asp:Asyncpostbacktrigger controlid="dlShop6"/>
               </Triggers>
           </asp:UpdatePanel>
		 </dl>
        </div>
        <div>
        <dl>
        <dt  style="height:80px; margin-bottom:10px;">Item_Code_URL</dt>
	...
	<div class="dBlock itemPriceFlag dlFloat">
		<dl>
			<dt>発売日</dt><dd><asp:TextBox runat="server" ID="txtRelease_Date" Width="85px" ReadOnly="true" ></asp:TextBox>
		...
		<dl>
            ...
            <dt style="visibility:hidden;">即日出荷</dt>
               <asp:UpdatePanel runat="server" id="UpdatePanel5" updatemode="Conditional"><ContentTemplate>
            <dd>
            <asp:CheckBox runat="server" ID="delivery_flag" oncheckedchanged="delivery_flag_CheckedChanged" AutoPostBack="true" Width="14px"  Visible="false"/>
            <%--対応する--%>
            </ContentTemplate> <Triggers>
            ...
            <dt class="tag">ORS タグ</dt>
			    <dd class="tag">
                    <asp:DropDownList runat="server" ID="ddlTagInfo" Width="83px">
                    </asp:DropDownList>
			    </dd>
        </dl>
         <dl>
		...
		<%--<dl class="itemFlag">
         ...
         <dt id="lbltaxrate" runat="server">税率</dt>
         <dd>
             <asp:DropDownList runat="server" ID="ddlTex_Rate">
...
<section id="content2">
	<div class="itemCmnSet editPage">
        ...
        <dl class="relatedProduct">
         ...
         <dl class="relatedProduct">
            <dt style="width:120px;">倉庫コード</dt>
            <dd><asp:TextBox ID="txtwarehouse_code" runat="server" Width="205" MaxLength="40" onkeypress="return isNumberKey(event)"></asp:TextBox></dd>
            <dt style="width:120px;">出荷日数</dt>
            <dd style="width:150px;"><asp:TextBox ID="txtday_ship" runat="server" Width="170px" MaxLength="40" onkeypress="return isNumberKey(event)"></asp:TextBox></dd>
       </dl>
        <dl class="relatedProduct">
...
<div class="itemCmnSet editPage">
			<div class="btn"><asp:Button runat="server" ID="btnPreview" Text="プレビュー" onclick="btnPreview_Click" />
...
<script type = "text/javascript">
    ...
    function ConfirmDel() {
        ...
        if (confirm("Are you sure you want to delete？")) {
            confirm_value1.value = "はい";
        } else {
            confirm_value1.value = "いいえ";
        }
        var val = document.forms[0].appendChild(confirm_value1);
        if (val.value.toString() == "はい") {
        }
    }
</script>
