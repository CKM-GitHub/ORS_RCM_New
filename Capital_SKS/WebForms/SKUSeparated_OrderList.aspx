<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SKUSeparated_OrderList.aspx.cs" Inherits="ORS_RCM.SKUSeparated_OrderList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UPanel" runat="server" UpdateMode="Conditional">
                                ...
                                <dl>
                                    ...
                                    <dd style="width: initial;">
                                        ...
                                        <asp:ImageButton ID="ImageButton2" runat="server" Width="16px" Height="15px"
                                            ImageUrl="~/Styles/clear.png" OnClick="ImageButton2_Click" />
                                    </dd>
            ...
            <div id="CmnContents2">
                ...
                <div class="stcCmnSet ordCmnSet editBox iconSet2">
                    <div class="listTableOver">
                        ...
                        <asp:GridView runat="server" AutoGenerateColumns="False" ID="gvSKU_SeparatedOrder"
                            ...
                            OnPageIndexChanging="gvSKU_SeparatedOrder_PageIndexChanging"
                            OnRowCommand="gvSKU_SeparatedOrder_RowCommand" PageSize="20">
                            <Columns>
                                <asp:TemplateField>
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="gvSKU_SeparatedOrder" />
        </Triggers>
    </asp:UpdatePanel>
